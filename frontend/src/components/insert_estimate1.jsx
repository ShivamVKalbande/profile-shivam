...
function Insert_estimate() {
  ...
  useEffect(() => {
    const validTaxRate = parseFloat(allTax) || 0;
    const validAllAmount = parseFloat(allAmount) || 0;
    const validTotalTransport = parseFloat(totalTransport) || 0;
    const validDiscountAmount = parseFloat(discountAmount) || 0;

    setOverallTotalAmount(
      validTaxRate + validAllAmount + validTotalTransport - validDiscountAmount
    );
  }, [allTax, allAmount, totalTransport, discountAmount]);
            ...
            <div className="inese">
              ...
              {showDropdown && !searchClicked && (
                <div>
                  ...
                  >
                    Search customer with name {showSearchDropdown ? "▼" : "►"}
                  </div>
                  {showSearchDropdown && (
                    <div>
                      <form
          ...
          <div className="inespa">
            <div className="inespb">
              ...
              <div className="inesq">
                ...
                <div className="inesqb">₹ {allTax / 2}</div>
              </div>
              <div className="inesq">
